...
jQuery(function(){
var message = '<p><strong>پوسته wikivb-birth با موفقیت فعال شد</strong> برای مدیریت قالب به پنل تنظیمات (<a href="<?php echo admin_url('admin.php?page=siteoptions'); ?>">نمایش > تنظیمات پوسته wikivb-birth</a>) مراجعه نمایید.</p>';
